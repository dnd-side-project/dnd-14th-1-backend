...
public enum AuthStatus implements StatusInterface {
    ...
    INVALID_OAUTH_REQUEST(400, 1400, "유효하지 않은 OAuth 요청입니다"),

    // 인증 실패 (1401)
    INVALID_REFRESH_TOKEN(401, 1401, "유효하지 않은 Refresh Token입니다"),
    EXPIRED_TOKEN(401, 1401, "만료된 토큰입니다"),

    // 권한 없음 (1403)
    INVALID_ISSUER(401, 1401, "유효하지 않은 issuer입니다"),
    INVALID_AUDIENCE(403, 1403, "유효하지 않은 audience입니다");
