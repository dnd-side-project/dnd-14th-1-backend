...
public record BadgeProgressResponse(
        ...
        @Schema(description = "현재 획득 배지 활성 이미지 URL (미획득 시 null)") String currentBadgeEnableImageUrl,
        ...
        @Schema(description = "다음 배지 활성 이미지 URL (모두 달성 시 null)") String nextBadgeEnableImageUrl) {}
